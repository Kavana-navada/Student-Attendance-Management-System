...
<head>
    ...
    <style>
        h2{
            background:linear-gradient(45deg,rgb(115, 214, 241),rgba(243, 232, 232, 1),rgb(115, 214, 241),rgba(245, 242, 242, 1),rgb(115, 214, 241),rgba(249, 244, 244, 1),rgb(115, 214, 241),rgba(240, 236, 236, 1),rgb(115, 214, 241));
            border:2px solid rgb(32, 76, 157);
            color: rgb(22, 54, 112);
        }
        th{
            background-color:rgb(106, 167, 184);
        }
        tr:hover{
        ...
        .export {
            background:linear-gradient(to right,rgb(216, 240, 247),rgb(216, 240, 247));
            color: rgb(8, 8, 8);
            font-weight: 700;
            padding: 10px 20px;
            border-radius: 5px;
            ...
            margin-top: 10px;
            font-size: 18px;
            border:2px solid rgb(78, 119, 244);
        }
        .export:hover {
            background:linear-gradient(to right,rgb(115, 214, 241),rgb(234, 230, 230),rgb(115, 214, 241));
        }
        a {
            color:black;
    ...
    if (isset($_POST['filter'])) {
        ...
        if (empty($_POST['firstDate']) || empty($_POST['secondDate']))  {
            ...
            if ($start_date > $end_date) {
                ...
                // Construct the attendance report table
            ...
            //    $table .= "<table>";
                ...
                foreach ($attendance as $student_name => $roll_nos) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        if($per<75){
                            $table .= "<td style='color:red;font-weight:bold;'>$per %</td>";
                        }
                        else{
                            $table .= "<td >$per %</td>";
                        }
                ...
                // $table .= "</table>";
                $table .= '<button id="thirdbutton" style="position:sticky;left: 650px;z-index: 1;" class="export"><a href="new2.php">Export to Excel</a></button><br><br>';
                // $table .= "</div>";
                // $table .= "</table>";
...
echo"</table>";
echo"</div>";
                // Store the table in session for exporting
        ...
        echo "<script>window.location.href='attmanagement.php';</script>";
    }
    ?>
</body>
</html>
