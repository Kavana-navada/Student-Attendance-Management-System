...
#download {
    ...
    width: 550px;
    margin-left: 33%;
    box-shadow: inset -3px -3px 17px rgb(7, 51, 36), 5px 5px 10px rgb(0, 0, 0), 5px 5px 5px rgb(247, 247, 247);
    border-radius: 30px;
    color: rgb(3, 57, 88);
}
...
a {
    ...
    font-size: 1.5rem;
    background: white;
    box-shadow: inset -1px -1px 7px rgb(7, 51, 36), 3px 3px 5px rgb(0, 0, 0), 3px 3px 3px rgb(247, 247, 247);
    border: none;
    color: rgb(3, 57, 88);
...
<body>
    ...
    <p id="download">Your file has been downloaded........<br><br>
        <a href="attmanagement.php">Back</a>
    </p>
      ...
      function exportToExcel() {
        $("#myTable").table2excel({
          ...
          complete: function() {
            ...
            window.location.href = "adminattendance.php";
          }
        });
      }
