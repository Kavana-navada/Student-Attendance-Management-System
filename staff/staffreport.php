...
<body>
    <div class="container" >
        <nav id="slidebar" >
            ...
            <li>
                <a href="todaysattendance.php" class="staffitem" id="today">
            ...
            <li>
                <a href="updateattendance.php" class="staffitem" >
            ...
            <div class="maintop">
              ...
              <?php
                ...
                while ($row1 = mysqli_fetch_assoc($result1))
                {
                    ...
                    <a href="treport.php?course=' . $row1["course"] . '&class=' . $row1["clas"] . '&sem=' . $row1["sem"] . '&sub=' . $row1["sname"]. '&sid=' . $row1["sid"] . '"><button class="report_btn">View Report</button></a>
                    <a href="shortage.php?course=' . $row1["course"] . '&class=' . $row1["clas"] . '&sem=' . $row1["sem"] . '&sub=' . $row1["sname"]. '&sid=' . $row1["sid"] . '"><button class="report_btn">View Shortage</button></a>
